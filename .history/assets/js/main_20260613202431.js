...
// ↓↓↓ CHANGE THIS to 'light' or 'dark' to set the default
const DEFAULT_THEME = 'dark';

function applyTheme(mode) {
  themeLink.href = mode === 'light'
    ? 'assets/css/styles-light.css'
...
// Load on start — saved preference wins, otherwise use DEFAULT_THEME
